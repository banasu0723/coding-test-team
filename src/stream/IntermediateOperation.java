...
public class IntermediateOperation {
    ...
    public static void main(String[] args) {
        ...
        numbers.stream()
                .peek(n -> System.out.print("before: " + n + ", ")) // 이것도 지연실행이다. 터미널 연산이 실행 되어야 실행이 된다.
                .map(n -> n * n)
                .peek(n -> System.out.print("after: " + n + ", "))
                .limit(5)
                .forEach(n -> System.out.println("최종값: " + n));  //forEach 는 스트림 파이프라인을 종료시킴 (터미널 연산이다)
        System.out.println("\n");
        ...
        numbers2.stream()
                .dropWhile(n -> n < 5) // 5보다 작은걸 건너띄다가 5보다 같거나 큰걸 만나면  뒤에 다 선택
                .forEach(n -> System.out.print(n + " "));
        System.out.println("\n");
