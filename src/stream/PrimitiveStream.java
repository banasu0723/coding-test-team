...
public class PrimitiveStream {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("개수: " + status.getCount());
        ...
        /**
         * 	•	객체 스트림 → 기본형: mapToInt, mapToLong, mapToDouble 사용 가능
         * 	•	기본형 → 다른 기본형: mapToInt, mapToLong, mapToDouble 사용 가능
         * 	•	기본형 → 객체: mapToObj 사용
         */
        // 3. 기본형 특화 매핑
        // int -> long 변환 매핑
        ...
        Stream<Integer> stream1 = IntStream.range(1, 5)
